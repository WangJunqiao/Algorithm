...
int query(int d,int hid,int L,int R,int rank){
	...
	if( L==BL ){
		toL1=toR1=0;
		toL2=_left[d][R]; toR2=(R-L+1)-toL2;
	}else{
		toL1=_left[d][L-1]; toR1=L-BL - toL1;
		toL2=_left[d][R]-toL1; toR2=(R-L+1)-toL2;
	}
	//以上这些是必须的
